    ...
    return (
        <>
            ...
            <div className=" flex flex-col font-[family-name:var(--font-lexend)] mx-auto gap-5 md:w-4/6">
                {!searchActive && <Image src={logo_horizontal} alt="crowded exams" sizes="100vw" className=" w-5/6 md:w-4/6 h-auto mx-auto mb-3 mt-[12vh]"/>}
                <Searchbar placeholder="Enter paper here..." callback={handleSearch} className={searchActive ? "md:mt-[-4.5rem]" : ""}/> 
                <div className=" flex flex-col gap-5">
                    <h2 className=" text-xl pl-5">{searchActive ? "Results" : "Recents"}</h2>
